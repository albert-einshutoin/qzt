...
const CORE_CONFORMANCE_MAP: &[(u8, &str, &str)] = &[
    ...
    (64, "Dense Line Index final line", "phase10_dense_line_index::dense_line_index_reads_final_line_without_newline"),
    (65, "Dense Line Index count", "phase10_dense_line_index::dense_line_index_count_mismatch_is_rejected"),
